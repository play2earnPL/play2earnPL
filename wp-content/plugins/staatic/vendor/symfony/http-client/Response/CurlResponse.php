...
final class CurlResponse implements ResponseInterface, StreamableInterface
{
    ...
    private static function parseHeaderLine($ch, string $data, array &$info, array &$headers, ?array $options, CurlClientState $multi, int $id, ?string &$location, ?callable $resolveRedirect, $logger) : int
    {
