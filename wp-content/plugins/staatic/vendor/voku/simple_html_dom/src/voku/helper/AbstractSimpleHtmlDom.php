...
abstract class AbstractSimpleHtmlDom
{
     ...
     */
    public abstract function innerHtml($multiDecodeNewHtmlEntity = \false, $putBrokenReplacedBack = \true) : string;
    /**
     * @param string $name
     */
     ...
     * @param bool $putBrokenReplacedBack
     */
    protected abstract function replaceChildWithString($string, $putBrokenReplacedBack = \true) : SimpleHtmlDomInterface;
    /**
     * @param string $string
     */
