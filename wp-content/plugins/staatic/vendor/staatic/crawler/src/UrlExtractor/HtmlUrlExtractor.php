...
final class HtmlUrlExtractor implements UrlExtractorInterface, FilterableInterface, TransformableInterface, LoggerAwareInterface
{
    ...
    public function __construct(DomParserInterface $domParser, $mapping = null, ?callable $filterCallback = null, ?callable $transformCallback = null, bool $extendedUrlContext = \false, $cssExtractor = null)
    {
