...
final class CrawlUrl
{
     ...
     */
    private $response;
    public function __construct(string $id, UriInterface $url, UriInterface $originUrl, $foundOnUrl = null, int $depthLevel = 0, int $redirectLevel = 0, array $tags = [], $transformedUrl = null, $normalizedUrl = null)
    {
        $this->id = $id;
        $this->url = $url;
    ...
    public static function create(UriInterface $url, self $parentCrawlUrl = null, bool $isRedirected = \false, array $tags = [], $transformedUrl = null, $normalizedUrl = null) : self
    {
    ...
    public function withNormalizedUrl($normalizedUrl) : self
    {
        $newCrawlUrl = clone $this;
