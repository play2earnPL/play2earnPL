...
class CrawlRequestFulfilled implements EventInterface
{
     ...
     */
    private $tags = [];
    public function __construct(UriInterface $url, UriInterface $transformedUrl, UriInterface $normalizedUrl, ResponseInterface $response, $foundOnUrl = null, array $tags = [])
    {
        $this->url = $url;
