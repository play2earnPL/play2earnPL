...
class CrawlRequestRejected implements EventInterface
{
     ...
     */
    private $tags = [];
    public function __construct(UriInterface $url, UriInterface $transformedUrl, UriInterface $normalizedUrl, Throwable $transferException, $foundOnUrl = null, array $tags = [])
    {
        $this->url = $url;
