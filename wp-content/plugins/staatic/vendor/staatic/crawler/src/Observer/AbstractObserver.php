...
abstract class AbstractObserver implements SplObserver
{
     ...
     * @param mixed[] $tags
     */
    public abstract function crawlFulfilled($url, $transformedUrl, $normalizedUrl, $response, $foundOnUrl, $tags) : void;
    /**
     * @param UriInterface $url
     * @param UriInterface $transformedUrl
     * @param UriInterface $normalizedUrl
     ...
     * @param mixed[] $tags
     */
    public abstract function crawlRejected($url, $transformedUrl, $normalizedUrl, $transferException, $foundOnUrl, $tags) : void;
