...
class StaticGenerator implements LoggerAwareInterface
{
    ...
    {
        return new CallbackObserver(function (UriInterface $url, UriInterface $transformedUrl, UriInterface $normalizedUrl, ResponseInterface $response, $foundOnUrl, array $tags) use($build) {
        ...
        }, function (UriInterface $url, UriInterface $transformedUrl, UriInterface $normalizedUrl, Throwable $transferException, $foundOnUrl, array $tags) use($build) {
