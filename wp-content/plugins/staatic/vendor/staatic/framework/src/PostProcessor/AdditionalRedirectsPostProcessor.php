...
final class AdditionalRedirectsPostProcessor implements PostProcessorInterface, LoggerAwareInterface
{
     ...
     */
    private $build;
    public function __construct(ResultRepositoryInterface $resultRepository, ResourceRepositoryInterface $resourceRepository, iterable $additionalRedirects, CrawlProfileInterface $crawlProfile, $transformers = null, ?string $template = null)
    {
