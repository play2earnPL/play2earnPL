...
final class CrawlResult
{
    ...
    public static function fromRejectedCrawlRequest(UriInterface $url, UriInterface $transformedUrl, UriInterface $normalizedUrl, Throwable $transferException, $foundOnUrl = null) : self
    {
        $response = null;
