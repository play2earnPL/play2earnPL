...
use Staatic\Vendor\phpseclib3\Crypt\DH\Parameters;
use Staatic\Vendor\phpseclib3\Crypt\DH\PrivateKey;
use Staatic\Vendor\phpseclib3\Crypt\DH\PublicKey;
...
abstract class DH extends AsymmetricKey
{
     ...
     */
    public static function createKey($params, $length = 0)
    {
        $class = new ReflectionClass(static::class);
        if ($class->isFinal()) {
