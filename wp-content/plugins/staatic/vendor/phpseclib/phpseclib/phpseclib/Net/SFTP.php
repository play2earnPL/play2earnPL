...
class SFTP extends SSH2
{
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        if (empty(self::$packet_types)) {
            ...
            self::$attributes = [0x1 => 'NET_SFTP_ATTR_SIZE', 0x2 => 'NET_SFTP_ATTR_UIDGID', 0x80 => 'NET_SFTP_ATTR_OWNERGROUP', 0x4 => 'NET_SFTP_ATTR_PERMISSIONS', 0x8 => 'NET_SFTP_ATTR_ACCESSTIME', 0x10 => 'NET_SFTP_ATTR_CREATETIME', 0x20 => 'NET_SFTP_ATTR_MODIFYTIME', 0x40 => 'NET_SFTP_ATTR_ACL', 0x100 => 'NET_SFTP_ATTR_SUBSECOND_TIMES', 0x200 => 'NET_SFTP_ATTR_BITS', 0x400 => 'NET_SFTP_ATTR_ALLOCATION_SIZE', 0x800 => 'NET_SFTP_ATTR_TEXT_HINT', 0x1000 => 'NET_SFTP_ATTR_MIME_TYPE', 0x2000 => 'NET_SFTP_ATTR_LINK_COUNT', 0x4000 => 'NET_SFTP_ATTR_UNTRANSLATED_NAME', 0x8000 => 'NET_SFTP_ATTR_CTIME', \PHP_INT_SIZE == 4 ? -1 << 31 : 0x80000000 => 'NET_SFTP_ATTR_EXTENDED'];
            ...
            self::$open_flags5 = [0x0 => 'NET_SFTP_OPEN_CREATE_NEW', 0x1 => 'NET_SFTP_OPEN_CREATE_TRUNCATE', 0x2 => 'NET_SFTP_OPEN_OPEN_EXISTING', 0x3 => 'NET_SFTP_OPEN_OPEN_OR_CREATE', 0x4 => 'NET_SFTP_OPEN_TRUNCATE_EXISTING', 0x8 => 'NET_SFTP_OPEN_APPEND_DATA', 0x10 => 'NET_SFTP_OPEN_APPEND_DATA_ATOMIC', 0x20 => 'NET_SFTP_OPEN_TEXT_MODE', 0x40 => 'NET_SFTP_OPEN_BLOCK_READ', 0x80 => 'NET_SFTP_OPEN_BLOCK_WRITE', 0x100 => 'NET_SFTP_OPEN_BLOCK_DELETE', 0x200 => 'NET_SFTP_OPEN_BLOCK_ADVISORY', 0x400 => 'NET_SFTP_OPEN_NOFOLLOW', 0x800 => 'NET_SFTP_OPEN_DELETE_ON_CLOSE', 0x1000 => 'NET_SFTP_OPEN_ACCESS_AUDIT_ALARM_INFO', 0x2000 => 'NET_SFTP_OPEN_ACCESS_BACKUP', 0x4000 => 'NET_SFTP_OPEN_BACKUP_STREAM', 0x8000 => 'NET_SFTP_OPEN_OVERRIDE_OWNER'];
            self::$file_types = [1 => 'NET_SFTP_TYPE_REGULAR', 2 => 'NET_SFTP_TYPE_DIRECTORY', 3 => 'NET_SFTP_TYPE_SYMLINK', 4 => 'NET_SFTP_TYPE_SPECIAL', 5 => 'NET_SFTP_TYPE_UNKNOWN', 6 => 'NET_SFTP_TYPE_SOCKET', 7 => 'NET_SFTP_TYPE_CHAR_DEVICE', 8 => 'NET_SFTP_TYPE_BLOCK_DEVICE', 9 => 'NET_SFTP_TYPE_FIFO'];
