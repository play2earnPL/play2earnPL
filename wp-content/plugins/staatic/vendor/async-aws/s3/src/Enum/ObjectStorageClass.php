...
final class ObjectStorageClass
{
    ...
    {
        return isset([self::DEEP_ARCHIVE => \true, self::EXPRESS_ONEZONE => \true, self::GLACIER => \true, self::GLACIER_IR => \true, self::INTELLIGENT_TIERING => \true, self::ONEZONE_IA => \true, self::OUTPOSTS => \true, self::REDUCED_REDUNDANCY => \true, self::SNOW => \true, self::STANDARD => \true, self::STANDARD_IA => \true][$value]);
    }
}
