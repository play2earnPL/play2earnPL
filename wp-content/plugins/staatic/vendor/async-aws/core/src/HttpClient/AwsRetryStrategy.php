...
class AwsRetryStrategy extends GenericRetryStrategy
{
    ...
    public function __construct(array $statusCodes = self::DEFAULT_RETRY_STATUS_CODES, int $delayMs = 1000, float $multiplier = 2.0, int $maxDelayMs = 0, float $jitter = 0.1, $awsErrorFactory = null)
    {
