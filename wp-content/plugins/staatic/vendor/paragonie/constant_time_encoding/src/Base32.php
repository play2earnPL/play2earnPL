...
abstract class Base32 implements EncoderInterface
{
     ...
     * @param bool $strictPadding
     */
    public static function decodeUpper($src, $strictPadding = \false) : string
    {
     ...
     * @param string $src
     */
    public static function encodeUnpadded($src) : string
    {
     ...
     * @param string $src
     */
    public static function encodeUpper($src) : string
    {
     ...
     * @param string $src
     */
    public static function encodeUpperUnpadded($src) : string
    {
     ...
     * @param bool $upper
     */
    public static function decodeNoPadding($encodedString, $upper = \false) : string
    {
     ...
     * @param bool $strictPadding
     */
    protected static function doDecode($src, $upper = \false, $strictPadding = \false) : string
    {
     ...
     * @param bool $upper
     */
    protected static function doEncode($src, $upper = \false, $pad = \true) : string
    {
