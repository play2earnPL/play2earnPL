...
final class HtmlUrlExtractorMapping extends BaseMapping
{
    ...
    public function mapping() : array
    {
        if ($this->cachedMapping === null) {
            ...
            $mapping['img'] = \array_merge($mapping['img'], ['data-srcset']);
            $mapping['amp-img'] = \array_merge($mapping['amp-img'], ['data-srcset']);
            $mapping['source'] = \array_merge($mapping['source'], ['data-srcset']);
