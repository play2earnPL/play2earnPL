...
class CachedContainer extends Container
{
    ...
    {
        return $this->privates['.service_locator.LQWyeDB'] = new \Staatic\Vendor\Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getHttpNetworkSettingService()
    {
        ...
        return $this->privates['Staatic\\WordPress\\Setting\\Advanced\\HttpNetworkSetting'] = new HttpNetworkSetting(
            $a
        );
    }
...
if (!\class_exists('Staatic\\Vendor\\BuildRepositoryProxy52119c7', \false)) {
    \class_alias(
        __NAMESPACE__ . '\\BuildRepositoryProxy52119c7',
        'Staatic\\Vendor\\BuildRepositoryProxy52119c7',
        \false
    );
}
class TransientCacheProxy1ba92cc implements CacheInterface, LazyObjectInterface
{
    ...
    public function delete($key)
    {
        ...
        throw new BadMethodCallException(
            'Cannot forward abstract method "Psr\\SimpleCache\\CacheInterface::delete()".'
        );
    }
...
class LoggerProxy58fa090 implements LoggerInterface, LazyObjectInterface
{
    ...
    public function emergency($message, $context = []) : void
    {
        if (isset($this->lazyObjectState)) {
            ...
            throw new BadMethodCallException(
                'Cannot forward abstract method "Psr\\Log\\LoggerInterface::emergency()".'
            );
        }
    }
